...
angular.module('ngWig')
    .config(['ngWigToolbarProvider', function (ngWigToolbarProvider) {
       ngWigToolbarProvider.addCustomButton('fontColor', 'nw-fontColor-button');
    }])
    .directive('nwFontColorButton', function() {
        return {
            restrict: 'E',
            replace: true,
            template: '<li class="nw-toolbar__item"><button colorpicker ng-model="fontcolor" class="nw-button nw-button--text-color" title="Font Color"></button></li>',
            link: function (scope) {
            }
        };
    });
...
angular.module("ng-wig/views/ng-wig.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("ng-wig/views/ng-wig.html",
    ...
    "      <div tabindex=\"-1\" ng-class=\"{'nw-invisible': editMode, 'nw-autoexpand': autoexpand}\" class=\"nw-editor__res\" ng-model=\"content\" ng-wig-editable></div>\n" +
    "    </div>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
