describe('provider: ngWigToolbar', function () {
    ...
    describe('setButtons function', () => {
        ...
        it('should throw an error if buttons are not provided', inject(() => {
            try {
        ...
        it('should not throw an error if buttons are provided', inject(() => {
    ...
    describe('addStandardButton function', () => {
        ...
        it('should throw an error if name is not provided', inject(() => {
            try {
        ...
        it('should throw an error if title is not provided', inject(() => {
            try {
        ...
        it('should throw an error if command is not provided', inject(() => {
            try {
        ...
        it('should not throw an error if name, title and command are provided', inject(() => {
    ...
    describe('addCustomButton function', () => {
        ...
        it('should throw an error if pluginName is not provided', inject(() => {
            try {
        ...
        it('should not throw an error if name and pluginName are provided', inject(() => {
    ...
    describe('$get function', () => {
        ...
        describe('getToolbarButtons function', () => {
            ...
            it('should throw an error if provided buttons have not been added first', inject(() => {
                try {
